...
const EducationalTape = ({ selectedOptions = {}, onOptionChange, program, pakke, currentEmblem }) => {
    ...
    useEffect(() => {
        ...
        sendMessageToIframes("hueband camera");
    }, [selectedHatbandColor]);
    useEffect(() => {
    ...
    useEffect(() => {
        ...
        sendMessageToIframes(message);
        sendMessageToIframes("materiale camera");
    }, [selectedMaterialType])
    useEffect(() => {
    ...
    useEffect(() => {
        ...
        sendMessageToIframes(message);
        sendMessageToIframes("hagerem camera");
    }, [selectedChinStrapColor])
    // useEffect(() => {
    ...
    useEffect(() => {
        ...
        sendMessageToIframes(message);
        sendMessageToIframes("knapfarve camera");
    }, [selectedButtonColor])
    useEffect(() => {
    ...
    useEffect(() => {
        ...
        sendMessageToIframes(message);
        sendMessageToIframes("year camera");
    }, [selectedYear])
