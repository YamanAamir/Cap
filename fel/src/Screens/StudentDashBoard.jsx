...
import { useSeasonTimer } from "../utils/seasonTimer";
...
const StudentDashboard = () => {
  ...
  const { timeLeft, isExpired, deadlineLabel } = useSeasonTimer();
  const [isSeasonPopupOpen, setIsSeasonPopupOpen] = useState(true); // resets every reload
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
        ...
        <div className=" border-slate-200 p-6 bg-white/50 backdrop-blur-sm w-[49.5%] absolute bottom-0 left-0 lg:w-[47%] 2xl:w-[43.5%] xl:w-[45%] ">
          ...
          {!isExpired && (
            <div style={{
              ...
              <div style={{ fontSize: '11px', color: '#166534', fontWeight: 600, lineHeight: 1.3 }}>
                Resterende tid til bestilling i denne sæson
                <div style={{ fontSize: '10px', fontWeight: 400, marginTop: '2px', color: '#15803d' }}>
                  Sidste dag: {deadlineLabel}
                </div>
              </div>
              <div style={{ fontWeight: 700, fontSize: '13px', color: '#0b3d3b', whiteSpace: 'nowrap', fontVariantNumeric: 'tabular-nums' }}>
                {timeLeft}
              </div>
            </div>
          )}
          ...
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="text-right">
              <div className="text-2xl font-bold text-slate-900">{calculateTotalPrice().toFixed(2)} DKK</div>
              <div className="text-xs text-slate-500">Servicegebyr på 79,00 kr. inkl.</div>
            </div>
          </div>
          <button
            onClick={
          ...
          <div className="bg-white/70 backdrop-blur-sm border-t border-green-600 p-4 flex-shrink-0">
            ...
            {!isExpired && (
              <div style={{
                ...
                <div style={{ fontSize: '11px', color: '#166534', fontWeight: 600, lineHeight: 1.3 }}>
                  Resterende tid
                  <div style={{ fontSize: '10px', fontWeight: 400, marginTop: '1px', color: '#15803d' }}>
                    Sidste dag: {deadlineLabel}
                  </div>
                </div>
                <div style={{ fontWeight: 700, fontSize: '12px', color: '#0b3d3b', whiteSpace: 'nowrap', fontVariantNumeric: 'tabular-nums' }}>
                  {timeLeft}
                </div>
              </div>
            )}
            ...
            <div className="flex justify-between items-center mb-3">
              <span className="text-sm font-medium text-slate-600">Samlet pris</span>
              <div className="text-right">
                <div className="text-xl font-bold text-slate-900">{calculateTotalPrice().toFixed(2)} DKK</div>
                <div className="text-xs text-slate-500">Servicegebyr på 79,00 kr. inkl.</div>
              </div>
            </div>
            <button
      ...
      <QuoteModal
        ...
        onClose={() => setIsSeasonPopupOpen(false) || setIsQuoteModalOpen(false)}
      ...
      {/* ── Season Expired Popup ── */}
      {isExpired && isSeasonPopupOpen && (
        <div style={{
          position: 'fixed',
          inset: 0,
          zIndex: 99999,
          ...
          padding: '24px 16px',
          overflowY: 'auto', // allows the whole area to scroll if content is tall
        }}>
          <style>{`
            .expired-popup-container {
              background: #ffffff;
              border-radius: 24px;
              ...
              margin: auto; /* keeps it centered when taller than screen */
            }
            ...
            @media (max-width: 480px) {
              ...
              .expired-popup-title { font-size: 16px !important; }
              .expired-popup-body { font-size: 12px !important; }
              .expired-popup-box-title { font-size: 12px !important; }
              .expired-popup-box-text { font-size: 11px !important; }
            }
          `}</style>
          ...
          <div className="expired-popup-container">
            {/* Close button */}
            <button
              onClick={() => setIsSeasonPopupOpen(false)}
              style={{
                position: 'absolute',
                top: '16px',
                right: '16px',
            ...
            <div className="expired-popup-title" style={{ fontWeight: 800, fontSize: '18px', color: '#111827', marginBottom: '12px', lineHeight: 1.3 }}>
              Tak for en fantastisk sæson!
            </div>

            <div style={{ width: '40px', height: '3px', background: '#0b3d3b', borderRadius: '99px', margin: '0 auto 20px' }} />

            <div className="expired-popup-body" style={{ fontSize: '13.5px', color: '#4b5563', lineHeight: 1.6, marginBottom: '20px' }}>
              Bestillingen af studenterhuer hos Student Life er nu officielt lukket.
              Vi er overvældede over den store opbakning I har vist os –
              <span style={{ color: '#0b3d3b', fontWeight: 600 }}> det betyder mere, end I tror.</span>
            </div>
            ...
            <div style={{
              ...
              <div className="expired-popup-box-title" style={{ fontWeight: 700, fontSize: '13px', color: '#166534', marginBottom: '4px' }}>Hold øje med os 👀</div>
              <div className="expired-popup-box-text" style={{ fontSize: '12px', color: '#15803d', lineHeight: 1.5 }}>
                Vi er allerede i gang med at forberede næste sæson og endnu federe muligheder.
              </div>
            </div>

            <div style={{ fontSize: '13px', fontWeight: 700, color: '#0b3d3b', marginBottom: '24px', opacity: 0.8 }}>
              Student Life – vi ses igen snart 🎓
            </div>
          </div>
        </div>
      )}
