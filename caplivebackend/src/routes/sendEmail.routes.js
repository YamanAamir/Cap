...
const { workflowStatusChange, sendCapEmail, stripePayment, getSessionDetails, stripeWebhook, createInstallmentOrder, payInstallment, directOrder } = require('../controllers/sendEmail.controller');
...
router.post('/direct-order', directOrder);
